...
//     void printNation(struct st_person*p[], int index, int number);
// int main(){
...
//     int num=0, female =0, male =0, ageSum=0;
//     float ageAverage=0;
//     char cn_name[6][5] = {"KR", "US", "JP", "CN", "FR", "--"};
...
//             ageSum += (2025 - p[i]-> birthyear);
//         }
//     }
//     ageAverage = ageSum/(float)num;

//     printf("[%s] Female:%d Male:%d average age:%.1f\n", cn_name[index], female, male,ageAverage);
// }
